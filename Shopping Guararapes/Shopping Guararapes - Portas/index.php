...
<center><h3>Automação</br> </h3></center>
</div>
...
<input name="login" type="text"   placeholder="INSIRA SEU LOGIN" autofocus required>
</div><br>


<div class="form-field">
<label for="senha">Senha</label>
<input name="senha" type="password"  minlength="11" maxlength="11" size="11" placeholder="INSIRA SUA SENHA" required>
</div><br>
